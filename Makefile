INC = include
SRC = src
OBJS = src/main.o src/vita/Script.o src/vita/modulesHandler.o src/vita/MemoryManager.o src/vita/GameObject.o src/vita/ItemHandler.o src/vita/Game.o src/vita/InputManager.o src/vita/Engine.o src/vita/AnimatedImage.o src/vita/Camera.o src/sampleClasses/Commander.o src/sampleClasses/Map.o src/sampleClasses/Node.o
