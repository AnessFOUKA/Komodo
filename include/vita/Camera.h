...
class Camera{
    ...
    public:
        ...
        void pushCameraGraphicOrder(std::string imgId,float x,float y,float imageX,float imageY,float imageWidth,float imageHeight,float scaleX,float scaleY,float alpha,Game* gameInstance);
};
#endif